...
<style>
  ...
  * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
  ...
  .stage { flex: 1; width: 100%; max-width: 480px; display: flex; align-items: center; justify-content: center; perspective: 1200px; padding: 8px 0; min-height: 0; }
  .card { position: relative; flex: 0 0 auto; transform-style: preserve-3d; transition: transform 0.55s cubic-bezier(.2,.7,.2,1); }
